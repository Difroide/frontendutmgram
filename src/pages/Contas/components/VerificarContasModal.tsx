...
export const VerificarContasModal = ({ isOpen, onClose, onConfirm, selectedContas, isVerifying, progress }: VerificarContasModalProps) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4 overflow-hidden">
      <div
        className="w-full max-w-2xl max-h-[90vh] bg-gray-800/40 backdrop-blur-xl rounded-xl border border-gray-600/30 border-blue-500/20 shadow-2xl overflow-hidden flex flex-col"
